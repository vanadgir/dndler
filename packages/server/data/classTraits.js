const classTraits = {
    ...
    "Brutal Critical": {
        ...
        "levelReq": {
            ...
            15: " and three additional dice at 15th level.",
        }
    },
    "Relentless Rage": {
        "description": [
    ...
    "Bardic Inspiration": {
        ...
        "levelReq": {
            5: "Your Bardic Inspiration die changes when you reach certain levels in this class. The die becomes a d8 at 5th level",
            10: ", or a d10 at 10th level",
            15: ", or a d12 at 15th level."
        }
    },
    "Jack of All Trades": {
    ...
    "Song of Rest": {
        ...
        "levelReq": {
            9: "\n \n The extra Hit Points increase when you reach certain levels in this class: 1d8 at 9th level",
            13: ", or 1d10 at 13th level",
            17: ", or 1d12 at 17th level."
        }
    },
    "Bard College": {
        "pickOne": [
    ...
    "Channel Divinity": {
        ...
        "levelReq": {
            ...
            18: " and beginning at 18th level, you can use it three times between rests."
        }
    },
    "Destroy Undead": {
        "description": "Starting at 5th level, when an undead fails its saving throw against your Turn Undead feature, the creature is instantly destroyed if its challenge rating is at or below a certain threshold, as shown in the Cleric table."
    },
    "Divine Intervention": {
        "description": [
    ...
    "Indomitable": {
        ...
        "levelReq": {
            ...
            17: " and three times between long rests starting at 17th level."
        }
    },
    // Monk
    ...
    "Mystic Arcanum": {
        ...
        "levelReq": {
            ...
            15: " and one 8th-level spell at 15th level",
            17: " and one 9th-level spell at 17th level."
        }
    },
    "Eldritch Master": {
        "description": [
    ...
    "Spellcasting": {
        "description": "You have the ability to cast spells.",
        "Bard": {
            "spellStat": "CHA",
            "ritual": true
        },
